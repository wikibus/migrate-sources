...
# download sql driver
wget https://github.com/microsoft/mssql-jdbc/releases/download/v8.2.2/mssql-jdbc-8.2.2.jre8.jar -P ontop/jdbc/ -c
...
./ontop/ontop materialize \
  -m ../src-gen/brochures.r2rml.ttl \
  -m ../src-gen/images.r2rml.ttl \
  -f ntriples \
  -o ./triples.nt \
  -p sql.properties
